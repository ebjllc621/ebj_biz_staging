/**
 * MFA TOTP Setup Route
 *
 * @description TOTP-specific MFA setup entry point
 * @method POST
 * @auth Required
 * @csrf Required
 *
...
/**
 * MFA TOTP setup handler
 *
 * Uses AuthServiceRegistry singleton pattern - NO per-request instantiation
 */
async function setupTotpHandler(context: ApiContext): Promise<ApiResponse<TotpSetupResponse>> {
