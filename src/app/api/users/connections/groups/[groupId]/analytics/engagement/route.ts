/**
 * Group Member Engagement API Route
 * GET /api/users/connections/groups/[groupId]/analytics/engagement
 *
...
export const GET = apiHandler(async (context: ApiContext) => {
  ...
  const engagement = await service.getGroupMemberEngagement(groupId, userId);

  return createSuccessResponse({ engagement }, context.requestId);
}, {
  requireAuth: true
});
