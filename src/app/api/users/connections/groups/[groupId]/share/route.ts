/**
 * Group Share Info API Route
 * GET /api/users/connections/groups/[groupId]/share
 *
...
export const GET = apiHandler(async (context: ApiContext) => {
  ...
  const shareInfo = await service.generateShareLink(groupId, userId);

  return createSuccessResponse({ shareInfo }, context.requestId);
}, {
  requireAuth: true
});
