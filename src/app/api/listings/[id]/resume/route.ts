/**
 * Listing Resume API Route - POST resume a paused listing
 *
 * @tier STANDARD
...
// ============================================================================
// POST - Resume a paused listing (owner only)
// ============================================================================
...
export const POST = apiHandler(async (context) => {
  ...
  // pathSegments: ['', 'api', 'listings', '[id]', 'resume']
  ...
  try {
    const listing = await listingService.resumeListing(listingId, user.id);
