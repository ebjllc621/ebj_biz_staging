/**
 * Accept Quote Response API Route
 *
 * POST /api/quotes/[quoteId]/responses/[responseId]/accept - Accept a bid
 *
 * @tier STANDARD
...
/**
 * POST /api/quotes/[quoteId]/responses/[responseId]/accept
 * Accept a bid (quote requester only)
 */
export const POST = withCsrf(apiHandler(async (context: ApiContext) => {
  ...
  await quoteService.acceptResponse(responseId, user.id);

  return createSuccessResponse({ message: 'Response accepted successfully' }, context.requestId);
}));
