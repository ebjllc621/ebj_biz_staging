...
/**
 * CreateEventModal - Create new event modal
 *
 * Features:
 * - BizModal wrapper
 * - Form validation
 * - Tier limit enforcement
 * - Location type support (physical/virtual/hybrid)
 * - Ticketing configuration
 *
 * @param {CreateEventModalProps} props
 * @returns {JSX.Element}
 */
export function CreateEventModal({ isOpen, onClose, onSuccess, listings }: CreateEventModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      ErrorService.capture('Create event error:', error);
