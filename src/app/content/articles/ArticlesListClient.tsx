/**
 * ArticlesListClient - Client Component for Articles List Page
 *
...
import { AlertCircle, Clock, WifiOff, FileText } from 'lucide-react';
  ...
  return (
    <div className="bg-gray-50 border border-gray-200 rounded-lg p-8 text-center">
      ...
      <p className="text-gray-600">
        Try adjusting your search or filters to discover articles.
      </p>
    </div>
  );
}
  ...
  const fetchArticles = useCallback(async () => {
    try {
      ...
      if (!result.success || !result.data) {
        throw new Error(result.error?.message || 'Failed to load articles');
      }
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Browse articles from local businesses and experts.
        </p>
      </div>
      ...
      {!isLoading && !error && articles.length === 0 && <ArticlesEmpty />}
