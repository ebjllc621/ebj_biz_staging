/**
 * VideosListClient - Client Component for Videos List Page
 *
...
import { AlertCircle, Clock, WifiOff, Play } from 'lucide-react';
  ...
  return (
    <div className="bg-gray-50 border border-gray-200 rounded-lg p-8 text-center">
      ...
      <p className="text-gray-600">
        Try adjusting your search or filters to discover videos.
      </p>
    </div>
  );
}
...
export function VideosListClient() {
  ...
  const fetchVideos = useCallback(async () => {
    try {
      ...
      const response = await fetch(`/api/content/videos?${params.toString()}`, {
        credentials: 'include',
      });
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Browse videos from local businesses and experts.
        </p>
      </div>
      ...
      {!isLoading && !error && videos.length === 0 && <VideosEmpty />}
