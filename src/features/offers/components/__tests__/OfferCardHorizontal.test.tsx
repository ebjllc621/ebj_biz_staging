/**
 * OfferCardHorizontal - Component Tests
 *
 * @tier STANDARD
 ...
 *
 * Tests rendering, links, days remaining formatting, and accessibility for OfferCardHorizontal component.
 */
...
describe('OfferCardHorizontal', () => {
  describe('rendering', () => {
    it('should render offer title', () => {
      render(<OfferCardHorizontal offer={mockOffer} />);
    ...
    it('should not render discount badge when no discount', () => {
      ...
      render(<OfferCardHorizontal offer={offerNoDiscount} />);

      expect(screen.queryByText(/-\d+%/)).not.toBeInTheDocument();
    });

    it('should render featured indicator when featured', () => {
      render(<OfferCardHorizontal offer={mockOffer} />);

      expect(screen.getByText('Featured Offer')).toBeInTheDocument();
    });

    it('should not render featured indicator when not featured', () => {
      const offerNotFeatured = { ...mockOffer, is_featured: false };
      render(<OfferCardHorizontal offer={offerNotFeatured} />);
    ...
    it('should not render prices when not provided', () => {
      ...
      render(<OfferCardHorizontal offer={offerNoPrice} />);
    ...
    it('should show "Ends today" for today expiration', () => {
      ...
      render(<OfferCardHorizontal offer={todayOffer} />);
    ...
    it('should show "Ends tomorrow" for tomorrow expiration', () => {
      ...
      render(<OfferCardHorizontal offer={tomorrowOffer} />);
    ...
    it('should not render quantity warning when stock > 10', () => {
      ...
      render(<OfferCardHorizontal offer={highStockOffer} />);
    ...
    it('should not render quantity warning when no stock data', () => {
      ...
      render(<OfferCardHorizontal offer={noStockOffer} />);
    ...
    it('should handle missing image gracefully', () => {
      ...
      const { container } = render(<OfferCardHorizontal offer={offerNoImage} />);
  ...
  describe('links', () => {
    it('should link to offer detail page', () => {
      const { container } = render(<OfferCardHorizontal offer={mockOffer} />);
  ...
  describe('days remaining', () => {
    it('should calculate days remaining correctly', () => {
      ...
      render(<OfferCardHorizontal offer={futureOffer} />);
  ...
  describe('styling', () => {
    ...
    it('should apply custom className', () => {
      const { container } = render(<OfferCardHorizontal offer={mockOffer} className="custom-class" />);
