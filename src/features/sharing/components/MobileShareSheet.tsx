/**
 * MobileShareSheet - Bottom sheet modal for mobile sharing
 *
 ...
 * @example
 * ```tsx
 * import { MobileShareSheet } from '@features/sharing/components';
 *
...
function MobileShareSheetInner({
  isOpen,
  onClose,
  entityType,
  entityId,
...
/**
 * MobileShareSheet with ErrorBoundary (STANDARD tier requirement)
 */
export function MobileShareSheet(props: MobileShareSheetProps) {
  return (
    <ErrorBoundary>
      <MobileShareSheetInner {...props} />
    </ErrorBoundary>
  );
}
