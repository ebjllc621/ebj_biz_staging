 ...
 * @tier SIMPLE
 * @phase Phase 5 - Reviews Section
 * @generated DNA v11.4.0
 * @governance Build Map v2.1 ENHANCED
 *
 * Features:
 * - Large average rating display
 * - 5-star filled/empty icons
 * - Horizontal bar histogram for each star level
 * - Total review count
 * - Percentage labels on bars
 *
 * @see docs/pages/layouts/listings/details/phases/PHASE_5_BRAIN_PLAN.md
 */
'use client';
...
export function ReviewSummary({ distribution, listingName }: ReviewSummaryProps) {
  // Calculate percentages for histogram bars
