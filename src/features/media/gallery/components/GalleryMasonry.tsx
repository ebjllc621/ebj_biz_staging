/**
 * GalleryMasonry - Masonry layout renderer
 *
 * Uses react-masonry-css via dynamic import for SSR safety.
 *
    ...
    >
      {items.map((item: GalleryItem, index: number) => (
        <button
          ...
          className={`relative w-full mb-4 overflow-hidden rounded-lg bg-gray-100 group focus:outline-none focus:ring-2 focus:ring-biz-orange focus:ring-offset-2 ${item.type === 'video' ? 'aspect-video' : 'aspect-square'}`}
